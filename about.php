                        ...
                        <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                            <ul class="information">
                                <li class="phone lt-sp003">
                                    <i class="fa fa-phone" aria-hidden="true"></i> +233 541 77 8545
                                </li>
                                <li class="email">
                                    <i class="fa fa-envelope" aria-hidden="true"></i> info@happyheart.com
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="container">
                            <div class="breadcrumbs-wrap">
                                <ul class="breadcrumbs-inner">
                                    <li><a href="homehead.php">Home</a></li>
                    ...
                    <div class="textbox-about">
                        ...
                        <div class="textbox-content">
                            <div class="about-introduce">
                                <p>
                                    Education is the process of facilitating learning, or the acquisition of knowledge, skills, values, beliefs, and habits. Education is about teaching, learning skills and knowledge.
                                </p>
                                <p>
                                    Education also means helping people to learn how to do things and encouraging them to think.
                                </p>
                                <p>
                                    It develops us a perspective of looking at life. It helps us build opinions and have points of view on things in life.
                                </p>
                                <div class="btn-about">
                                    <a href="#" class="btn-box-shadow">read more</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flat-carousel-box data-effect clearfix" data-gap="30" data-column="4" data-column2="2" data-column3="1" data-column4="1" data-dots="false" data-auto="false" data-nav="false">
                    <div class="owl-carousel">
                        <div class="team-box-layout-h1">
                            <div class="item-img"> 
                                <img src="image/a.jpeg" alt="images" class="img-fluid">
                            </div>
                            <div class="item-content">
                                <div class="item-title">
                                    <a href="#">Adriana Kuma</a>
                                </div>
